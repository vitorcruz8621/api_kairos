class HorariosSGC {
    ...
    retornarMarcacoes() {
        ...
        var arrHoras = []
        //const chamadoIt : HTMLTableElement<any> = document.getElementById("chamadoIt");
        const chamadoIt : HTMLElement = document.getElementById("chamadoIt");
        const arrHorasMisturadas = [...chamadoIt.tBodies.item(0).rows].map(element => {
